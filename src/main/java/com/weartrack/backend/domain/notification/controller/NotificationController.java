...
@Tag(name = "Notification", description = "푸시 알림 토큰 및 알림 설정 API")
public class NotificationController {
    ...
    @Operation(
            summary = "FCM 토큰 등록",
            description = """
                    현재 로그인한 사용자의 FCM 디바이스 토큰을 등록합니다.
    ...
    @Operation(
            summary = "FCM 토큰 삭제",
            description = """
                    현재 로그인한 사용자에게 등록된 FCM 디바이스 토큰을 삭제합니다.
    ...
    @Operation(
            summary = "알림 설정 조회",
            description = """
                    현재 로그인한 사용자의 푸시 알림 수신 설정을 조회합니다.
    ...
    @Operation(
            summary = "알림 설정 변경",
            description = """
                    현재 로그인한 사용자의 푸시 알림 수신 설정을 변경합니다.
